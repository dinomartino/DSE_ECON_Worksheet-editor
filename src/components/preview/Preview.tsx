              ...
              >
                {row.map((cell, cellIndex) => {
                  ...
                  const rangeOutline = rangeEdge
                    ? [
                        rangeEdge.top ? "inset 0 2px 0 0 #0d77c9" : "",
                        rangeEdge.bottom ? "inset 0 -2px 0 0 #0d77c9" : "",
                        rangeEdge.left ? "inset 2px 0 0 0 #0d77c9" : "",
                        rangeEdge.right ? "inset -2px 0 0 0 #0d77c9" : "",
                      ]
                        .filter(Boolean)
                        .join(", ")
                    : undefined;
                  return (
                    <td
                       ...
                       * *question* already paints `#eef6fc` across its whole box, so a
  ...
  return (
    ...
    >
      {edge && (
        ...
        >
          <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#0d77c9]" />
          <span className="h-0.5 flex-1 bg-[#0d77c9]" />
          <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#0d77c9]" />
        </span>
      )}
        ...
        className={`absolute -left-[26px] top-0.5 flex w-[18px] cursor-grab flex-col items-center justify-center gap-0 overflow-hidden rounded border py-0.5 leading-none transition-colors duration-150 active:cursor-grabbing ${
          isDragging
            ...
            : isRunHead
              ...
              ? "border-[#5ba8dd] bg-[#d9ebf8] text-[#0d77c9] shadow-[0_1px_1.5px_rgba(0,0,0,0.07)] hover:!border-[#0d77c9] hover:!bg-[#bcdcf2]"
              : "border-[#cfc9c2] bg-[#faf9f8] text-[#9a948e] shadow-[0_1px_1.5px_rgba(0,0,0,0.07)] group-hover/drag:border-[#8fc2e9] group-hover/drag:bg-white group-hover/drag:text-[#6b6764] hover:!border-[#0d77c9] hover:!bg-[#d9ebf8] hover:!text-[#0d77c9]"
        }`}
      >
 ...
 */
const SELECTED_ITEM = "bg-[#0d77c9]/[0.04] shadow-[0_0_0_1px_#bcdcf2]";
